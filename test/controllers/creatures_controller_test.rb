...
class CreaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creature" do
    assert_difference("Creature.count") do
      post creatures_url, params: { creature: { cooking_effect: @creature.cooking_effect, description: @creature.description, dlc: @creature.dlc, edible: @creature.edible, hearts_recovered: @creature.hearts_recovered, image_url: @creature.image_url, name: @creature.name } }
    end
  ...
  test "should update creature" do
    patch creature_url(@creature), params: { creature: { cooking_effect: @creature.cooking_effect, description: @creature.description, dlc: @creature.dlc, edible: @creature.edible, hearts_recovered: @creature.hearts_recovered, image_url: @creature.image_url, name: @creature.name } }
