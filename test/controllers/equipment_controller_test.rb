...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference("Equipment.count") do
      post equipment_index_url, params: { equipment: { description: @equipment.description, dlc: @equipment.dlc, image_url: @equipment.image_url, name: @equipment.name } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { description: @equipment.description, dlc: @equipment.dlc, image_url: @equipment.image_url, name: @equipment.name } }
